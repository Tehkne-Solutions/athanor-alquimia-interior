import { BookOpenText, CheckCircle2, Footprints, LockKeyhole, Seedling, ShieldCheck, Sprout } from 'lucide-react';
...
export function GardenPage() {
  ...
  const selectedDecision = earthWorkDecisionOptions.find((option) => option.id === workProgress?.decision);
