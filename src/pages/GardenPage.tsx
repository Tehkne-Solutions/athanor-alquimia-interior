import { BookOpenText, CheckCircle2, Clock3, Footprints, ListChecks, LockKeyhole, ShieldCheck, Sprout } from 'lucide-react';
...
export function GardenPage() {
  ...
  const gardenTitle = rhythmProgress?.status === 'completed'
