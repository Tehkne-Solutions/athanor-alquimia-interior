import { Archive, ArrowRight, BookOpenText, CheckCircle2, Circle, Clock3, FolderOpen, History, Layers3, MoonStar, RefreshCw, ShieldCheck, Sparkles } from 'lucide-react';
