...
export function MissionPage() {
  ...
  const begin = () => { if (!mission) startMission(); navigate('/mission/word-before-response/classification'); };
  return (
    <div className="page">
      ...
      <div className="mission-actions"><Button variant="ghost" onClick={() => navigate('/temple')}><PauseCircle size={18}/> Pausar e voltar ao Átrio</Button><Button onClick={begin}>Começar classificação <ArrowRight size={18}/></Button></div>
    </div>
  );
}
