...
const allSpiritNodes = [...spiritFoundationNodes, ...spiritThreadNodes, ...spiritCenterNodes, ...spiritCouncilNodes, ...spiritDecisionNodes, ...spiritReturnNodes];
...
export function SpiritSanctuaryPage() {
  ...
  const heroState = returnCompleted
    ? { title: 'Quinto componente criado', description: 'A Chave preserva revisão, desconhecimento, arquivo e o direito de não retomar.' }
    : returnProgress
