...
export function CharacterPage() {
  ...
  const rawSpiritOrb = useSpiritOrbStore((state) => state.progress);
  ...
  const sourceReturnKeyId = spiritReturnCompleted && rawSpiritReturn ? rawSpiritReturn.completedAt ?? `${rawSpiritReturn.sourceDecisionId}:possible-return-key` : undefined;
  const spiritOrbCreated = Boolean(sourceReturnKeyId && rawSpiritOrb?.sourceReturnKeyId === sourceReturnKeyId && rawSpiritOrb.orbCreated);
