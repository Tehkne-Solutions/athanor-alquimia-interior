import { Award, Clock3, Compass, Droplets, Flame, Footprints, Gem, GitBranch, ListChecks, Map, Settings2, Shield, Sparkles, Sprout } from 'lucide-react';
